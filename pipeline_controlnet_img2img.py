    ...
    def __call__(
        ...
        if isinstance(controlnet, ControlNetModel):
            ...
            if isinstance(control_image[0], list):
                ...
                # All same controlnets get batched together
        ...
        f_map = torch.zeros((len(prompt),1280, latents.shape[-1]//2, latents.shape[-1]//2)).half().to(device)
        ...
        return StableDiffusionPipelineOutput(images=[f_map, image], nsfw_content_detected=has_nsfw_concept)
